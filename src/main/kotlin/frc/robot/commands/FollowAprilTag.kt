...
class FollowAprilTag(val aprilTagID: Int) : Command() {
    ...
    override fun execute() {
        ...
        val rotateKP = 1.0 // todo change sign?
        ...
        val xKP = 1.0 // todo change sign?
        val xError = xToTag - 1.0 // current - goal of 1 meter
        val xP = xKP * xError
        val driveX = xP +
                (-0.01 * xError.sign) // gives it a little more kick towards 0 error (constant) // todo change sign?
        ...
        val yP = yKP * yError
        val driveY = yP +
                (-0.01 * yError.sign) // gives it a little more kick towards 0 error (constant) // todo change sign?
